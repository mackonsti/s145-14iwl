 ...
 *
 * NOTES:
 * Adding non-existent but Apple native ACPI devices under LPCB in IODeviceTree list.
 *
 * KEXT REFERENCES:
...
DefinitionBlock ("SSDT-APPLE.aml", "SSDT", 2, "Clover", "APPLE", 0x00000000)
{
    External (_SB_.PCI0.LPCB, DeviceObj)

    // According to the original Apple ACPI tables for MacBookPro15,2 there are sub-systems
    // present under Device (LPCB) that the Lenovo S145-14iWL firmware does not have natively.
    // Adding these may not really add functionality but allows for improved compatibility.
