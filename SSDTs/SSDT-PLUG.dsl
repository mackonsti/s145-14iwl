/*
 * Generic XCPM power management compatibility table with "Darwin" method
 *
 * SOURCES:
 ...
 *
 * Please note that this table is only a sample and may need to be adapted
 * to fit your board's ACPI stack. For instance, both scope and device name
 * may vary (e.g. _SB_.PR00 instead of _PR_.CPU0).
 *
 * While the table contains several examples of CPU paths, you should remove
 * all the entries that are irrelevant to your board.
 */

DefinitionBlock ("SSDT-PLUG.aml", "SSDT", 2, "OC", "_PLUG", 0x00000000)
{
